...
def ask_physical_activity():
    ...
    return ask_question(
        ...
        lambda: print("Remember to engage in at least 30 minutes of moderate physical activity each day. This can help improve your physical and mental health.") or ask_physical_activity()
...
def ask_online_work():
    ...
    return ask_question(
        ...
        lambda: print("Remember to explore online work options. This can help supplement your income.") or ask_online_work()
...
def ask_financial_health():
    ...
    return ask_question(
        ...
        lambda: print("Remember to prioritize your financial health. Consider talking to a financial advisor or setting up a budget to better manage your finances.") or ask_financial_health()
...
def ask_social_support():
    ...
    return ask_question(
        ...
        lambda: print("Remember to prioritize your social connections. Consider reaching out to friends or family members for support.") or ask_social_support()
