...
cat $HOME/.ssh/id_ed25519_github.pub | termux-clipboard-set # Copy SSH key to clipboard

echo "SSH key copied to clipboard. Please add it to your GitHub account." # Prompt user to add SSH key to GitHub account
...
gpg --armor --export $gpg_key_id | termux-clipboard-set # Copy GPG key to clipboard

echo "GPG key copied to clipboard. Please add it to your GitHub account." # Prompt user to add GPG key to GitHub account
